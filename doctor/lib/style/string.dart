class StringData {
  ...
  final String noticIntro="Quickly capture what’s on your mind. Formula, questions, answer etc and get reminded later for future use. ";
  ...
  final String chooseroleText="Wel come\nChoose your role to continue";
