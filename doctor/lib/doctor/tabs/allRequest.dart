...
class RequestsDoctor extends StatefulWidget {
  RequestsDoctor({Key key}) : super(key: key);
  @override
  _RequestsDoctorState createState() => _RequestsDoctorState();
}

class _RequestsDoctorState extends State<RequestsDoctor> {
  bool isLoading = true;
  bool isFound = false;
  ...
  fetchData() async {
    ...
    final response = await http.post(Apis().mAllRequests,
