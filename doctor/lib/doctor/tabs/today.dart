...
class TodayDoctor extends StatefulWidget {
  TodayDoctor({Key key}) : super(key: key);
  @override
  _TodayDoctorState createState() => _TodayDoctorState();
}

class _TodayDoctorState extends State<TodayDoctor> {
  bool isLoading = true;
  bool isFound = false;
  ...
  fetchData() async {
    ...
    final response = await http.post(Apis().mTodaysRequests,
